...
*设置以开始播放运动。
*
*@param[in]motionQueueEntry CubismMotionQueueManager管理的运动
*@param[in]userTimeSeconds增量时间累计值[秒]
*/
...
*/
  ...
  public setOffsetTime(offsetSeconds: number): void {
    ...
    *
    *活动起火的检查。
    *输入的时间以所称的运动定时为0的秒数进行。
    *
    *@param beforeCheckTimeSeconds上次事件检查时间[秒]
    *@param motionTimeSeconds此次播放时间[秒]
    */
